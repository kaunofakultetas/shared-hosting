...
//
//  Reached from a card on /vm. Header card with the VM icon,
//  id/status, inline rename (pencil → text field with Enter/
//  Escape), owner + uptime and the start/stop button, then
//  the container chips and two tabs: management tool cards
//  (Controls) and the domain table (Domain Names). Data
//  refreshes every 5 seconds; a 401 on the fetch bounces to
//  "/".
//
...
//    Footer            — burgundy copyright bar
//    VirtualServerPage — data + actions (default export)
//
//  Used by:
...
//
// Used by:
//   - VirtualServerPage (below) — loading state and full page
// -----------------------------------------------------------
...
// -----------------------------------------------------------
//
// Owns the VM data (polled every 5 seconds), the rename edit
// state and the tab selection, and the start/stop / rename /
// open-tool actions.
//
// Used by:
//   - router.jsx — route /vm/:virtualServerID (via
...
export default function VirtualServerPage({ virtualServerID, authdata }) {
